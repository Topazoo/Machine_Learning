...
def calc_sim(pref_dict, cat1, cat2):
    ...
    '''Calculate the Euclidean Distance of all shared
       items and sum them using a list comprehension'''
...
print calc_sim(recommendations.critics, 'Lisa Rose', 'Gene Seymour')
print calc_sim(recommendations.critics, 'Lisa Rose', 'Claudia Puig')
